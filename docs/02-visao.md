...
| **Afeta**                        | [partes interessadas]  |
| **O impacto é**                  | [descrever o impacto]  |
| **Uma solução de sucesso seria** | [descrever a solução]  |
...
| **Que**                   | [declaração de benefícios-chave]            |
| **Ao contrário de**       | [concorrência ou alternativa]               |
...
| :---------------------------- | :---------------- | :---------------- |
| [nome do tipo de stakeholder] | [descrição breve] | [resumo]          |
